...
import { Cloud, YesNo, ConfigData, intialConfigData, generalConfigApis, successMessage, errorMessage, substancePreventionSuccessMessage } from "./generalConfigService";
...
export default class GeneralConfigStore {
    ...
    //Save
    private saveConfigValue = async<TKey extends keyof ConfigData>(key: TKey, successMsg: string, errorMsg: string) => {
