...
import { BlockTabBar, Tab } from "../../components/block-layout/BlockTabBar";
...
const tabs: Tab[] = [
    ...
    { slot: "attributeMapping", title: "Attribute Mapping", icon: attributes, component: <AttributeMappingTab /> },
