...
export const CreateOrUpdateUserPopup = () => {
        ...
        return (
            <>
                ...
                <oj-input-text
                    ...
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "username");
                    }}
                ...
                <oj-input-text
                    ...
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "email");
                    }}
                ...
                <oj-input-text
                    ...
                    autocomplete="off"
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "company");
                    }}
                ></oj-input-text>
                <br />
                <br />
                ...
                <oj-input-text
                    ...
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "phone");
                    }}
                ...
                <oj-input-text
                    ...
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "businessTitle");
                    }}
                    autocomplete="off"
                ></oj-input-text>
                <br />
                ...
                <oj-select-many
                    ...
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "roles");
                    }}
                ...
                <oj-switch
                    ...
                    onvalueChanged={(event) => {
                        valueChangeHandler(event, "active");
                    }}
                ></oj-switch>
            </>
        );
    ...
    return (
        <Popup
            show={popupHooks.createUpdate}
            popupTitle={`${mode} User`}
            body={popupBody}
            footer={popupFooter}
        ></Popup>
    );
