...
export const UsersTab = observer(() => {
    ...
    const actions: ActionBarElement[] = [
        ...
        },
        {
            ...
            title: "Create User",
            action: () => {
                openCreateUpdatePopup("Create");
            },
            icon: Icons.blockIcons.createNew,
        ...
        },
        {
            ...
            action: () => {
                openCreateUpdatePopup("Update");
            },
            icon: Icons.icons.updateUser,
            inActionMenu: { present: true, showIcon: true },
        },
        {
            type: Action.Reset,
            ...
            icon: Icons.icons.resetPassword,
            inActionMenu: { present: true, showIcon: true },
        },
    ];
    ...
    return (
        <>
            <div className="oj-sm-margin-2x">
                <h5 className="left-pad">Users</h5>
                <div>
                    <ActionBar actions={actions} filterHandler={setFilter} />
                        ...
                        {isLoading ? (
                            ...
                            <DataTable
                                ...
                                templates={getReadonlyTemplates(
                                    Object.values(tableTemplates.ADMIN_PANEL.USERS),
                                )}
...
const ResetPassword = observer(() => {
    const {
        userStore: { popupHooks, closePopup, selectedUser, resetPassword },
    } = useAdminPanelStore();
    ...
    const body = () => {
        return (
            <div>
                <p>
                    This will reset the password for <b>{selectedUser?.name}</b> and send the new one to{" "}
                    <b>{selectedUser?.email}</b>. Do you wish to continue?
                </p>
            </div>
        );
    };
